...
GGJ2020repair-Linux-Debug:
	 $(PROJECTBUILD) GGJ2020repair Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

GGJ2020repair-Linux-DebugGame:
	 $(PROJECTBUILD) GGJ2020repair Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

GGJ2020repair-Linux-Shipping:
	 $(PROJECTBUILD) GGJ2020repair Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

GGJ2020repair-Linux-Test:
	 $(PROJECTBUILD) GGJ2020repair Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

GGJ2020repair:
	 $(PROJECTBUILD) GGJ2020repair Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

GGJ2020repairEditor-Linux-Debug:
	 $(PROJECTBUILD) GGJ2020repairEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

GGJ2020repairEditor-Linux-DebugGame:
	 $(PROJECTBUILD) GGJ2020repairEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

GGJ2020repairEditor-Linux-Shipping:
	 $(PROJECTBUILD) GGJ2020repairEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

GGJ2020repairEditor-Linux-Test:
	 $(PROJECTBUILD) GGJ2020repairEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

GGJ2020repairEditor:
	 $(PROJECTBUILD) GGJ2020repairEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
